...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_FUNNY_DRIVER_NAME_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FUNNY_DRIVER_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GREETINGS_PROMPT, 1);
